...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className={`relative bg-gray-100 dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 flex flex-col h-full transition-all duration-300 ${
            ...
            <div className="space-y-1">
              {sortedConversations.map((conv) => (
                <div key={conv.id} className="group relative">
                  <Button
                    variant={activeConversation === conv.id && currentPage === 'chat' ? "secondary" : "ghost"}
                    className="w-full justify-start text-left h-auto p-2 group-hover:bg-gray-200 dark:group-hover:bg-gray-800"
      ...
      <Button
        variant="ghost"
        size="sm"
        className="absolute top-4 -right-3 h-6 w-6 p-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full shadow-sm hover:bg-gray-100 dark:hover:bg-gray-700 z-10"
