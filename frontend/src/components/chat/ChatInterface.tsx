          ...
          {messages.length === 0 && !isLoading ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Your private AI assistant. Start a conversation below.
              </p>
            ...
            messages.map((message) => (
              <div key={message.id} className={`flex gap-4 items-start ${message.role === 'user' ? 'justify-end' : ''}`}>
                ...
                <div className={`flex-grow max-w-3xl ${message.role === 'user' ? 'flex justify-end' : ''}`}>
                  <Card className={`p-4 ${message.role === 'user' ? 'bg-blue-50 dark:bg-blue-950/50 border-blue-200 dark:border-blue-800/50' : 'bg-gray-50 dark:bg-gray-950'}`}>
